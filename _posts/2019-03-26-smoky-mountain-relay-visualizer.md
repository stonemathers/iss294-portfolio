...
<img src="{{ "/images/race-start.png" | prepend: site.baseurl }}{{ img }}" alt="Visualization Start">
...
<img src="{{ "/images/race-middle.png" | prepend: site.baseurl }}{{ img }}" alt="Visualization Middle">

<img src="{{ "/images/race-end.png" | prepend: site.baseurl }}{{ img }}" alt="Visualization End">

[Explore this visualization](https://stonemathers.github.io/smr-legs/) or [peruse the source code](https://github.com/stonemathers/smr-legs)!